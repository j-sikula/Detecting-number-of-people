 ...
 * Defining ports
 */
#define INT     PD2     //input active low - view page 2 @ https://www.st.com/content/ccc/resource/technical/layouts_and_diagrams/schematic_pack/group2/81/6d/6a/e1/a3/77/40/41/X-NUCLEO-53L7A1_SCHEMATIC/files/x-nucleo-53l7a1-schematic.pdf/jcr:content/translations/en.x-nucleo-53l7a1-schematic.pdf
#define I2C_RST PD3     //output  active HIGH
